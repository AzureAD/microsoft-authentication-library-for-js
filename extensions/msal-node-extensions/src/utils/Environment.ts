...
export class Environment {
    ...
    static isWindowsPlatform(): boolean {
        return this.getEnvironmentVariable(Constants.ENVIRONMENT.PLATFORM) === Platform.WINDOWS;
    }

    static isLinuxPlatform(): boolean {
        return this.getEnvironmentVariable(Constants.ENVIRONMENT.PLATFORM) === Platform.LINUX;
    }

    static isMacPlatform(): boolean {
        return this.getEnvironmentVariable(Constants.ENVIRONMENT.PLATFORM) === Platform.MACOS;
    }
