...
if (parseInt(process.env.BEACHBALL)) {
    ...
    exec("lerna --scope @azure/* --scope msal --scope vanilla-js-test* --scope @azure/node-token-validation --ignore @azure/msal-angularjs bootstrap", function (error, stdout, stderr) {
        if (stdout) {
