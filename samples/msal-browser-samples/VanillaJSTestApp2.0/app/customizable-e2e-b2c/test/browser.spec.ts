...
import { msalConfig as b2cMsalConfig, request as b2cTokenRequest } from "../authConfig.json";
import { getBrowser, getHomeUrl, b2cAadPpeEnterCredentials, b2cLocalAccountEnterCredentials, clickLoginPopup, clickLoginRedirect, waitForReturnToApp } from "../../testUtils";
import fs from "fs";
...
describe("B2C Tests", () => {
    ...
    beforeAll(async () => {
        ...
        fs.writeFileSync("./app/customizable-e2e-b2c/testConfig.json", JSON.stringify({msalConfig: b2cMsalConfig, request: b2cTokenRequest}));
    });
