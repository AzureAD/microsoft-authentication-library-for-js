...
import { AzureEnvironments, AppTypes, FederationProviders } from "../../../../../e2eTestUtils/Constants";
import { LabClient } from "../../../../../e2eTestUtils/LabClient";
import { msalConfig as ciamMsalConfig, request as ciamTokenRequest } from "../authConfigs/ciamAuthConfig.json";
...
describe("CIAM-Prod Tests", () => {
    ...
    beforeAll(async () => {
        ...
        const labApiParams: LabApiQueryParams = {
            ...
            federationProvider: FederationProviders.CIAM
        };
        ...
        fs.writeFileSync("./app/customizable-e2e-test/testConfig.json", JSON.stringify({msalConfig: ciamMsalConfig, request: ciamTokenRequest}));
    });
    ...
    describe("login Tests", () => {
        beforeEach(async () => {
            ...
            BrowserCache = new BrowserCacheUtils(page, ciamMsalConfig.cache.cacheLocation);
        ...
        it("Performs loginRedirect", async () => {
            ...
            await verifyTokenStore(BrowserCache, ciamTokenRequest.scopes);
        });
        ...
        it("Performs loginRedirect with relative redirectUri", async () => {
            ...
            fs.writeFileSync("./app/customizable-e2e-test/testConfig.json", JSON.stringify({msalConfig: ciamMsalConfig, request: relativeRedirectUriRequest}));
            page.reload();
    ...
    describe("acquireToken Tests", () => {
        ...
        it("acquireTokenSilent from Cache", async () => {
            ...
            const telemetryCacheEntry = await BrowserCache.getTelemetryCacheEntry(ciamMsalConfig.auth.clientId);
            ...
            await BrowserCache.removeTokens([BrowserCacheUtils.getTelemetryKey(ciamMsalConfig.auth.clientId)]);
