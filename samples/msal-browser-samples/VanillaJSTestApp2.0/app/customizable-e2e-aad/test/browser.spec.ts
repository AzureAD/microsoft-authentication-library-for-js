...
import { getBrowser, getHomeUrl, clickLoginPopup, clickLoginRedirect, clickLogoutPopup, clickLogoutRedirect, waitForReturnToApp } from "../../testUtils";
import fs from "fs";
import { RedirectRequest } from "../../../../../../lib/msal-browser/src";

const SCREENSHOT_BASE_FOLDER_NAME = `${__dirname}/screenshots`;
const TEST_CONFIG = "./app/customizable-e2e-aad/testConfig.json";
let sampleHomeUrl = "";
...
describe("AAD-PPE Tests", () => {
    ...
    beforeAll(async () => {
        ...
        fs.writeFileSync(TEST_CONFIG, JSON.stringify({msalConfig: aadMsalConfig, request: aadTokenRequest}));
    });
    ...
    describe("login Tests", () => {
        ...
        it("Performs loginRedirect with relative redirectUri", async () => {
            ...
            fs.writeFileSync(TEST_CONFIG, JSON.stringify({msalConfig: aadMsalConfig, request: relativeRedirectUriRequest}));
            page.reload();
