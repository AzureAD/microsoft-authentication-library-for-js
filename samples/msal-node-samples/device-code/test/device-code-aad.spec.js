...
describe('Device Code AAD PPE Tests', function () {
    ...
    var username;
    var accountPwd;
    var screenshotFolder = "".concat(testUtils_1.SCREENSHOT_BASE_FOLDER_NAME, "/device-code/aad");
                        ...
                        deviceCodeCallback = function (deviceCodeResponse) { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
                            ...
                            return (0, tslib_1.__generator)(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        _a.sent();
                                        return [4 /*yield*/, (0, testUtils_1.approveRemoteConnect)(page, screenshot)];
                                    case 2:
                                        _a.sent();
...
//# sourceMappingURL=device-code-aad.spec.js.map