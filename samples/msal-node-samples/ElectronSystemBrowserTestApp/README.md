...
- Install [Node.js](https://nodejs.org/en/) (version `>=22.12.0` is required), [Electron.js](https://www.electronjs.org/) and [TypeScript](https://www.typescriptlang.org/) if needed.
