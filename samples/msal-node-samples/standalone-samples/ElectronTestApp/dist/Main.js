...
var Main = /** @class */ (function () {
    ...
    Main.listenForLogin = function () {
        var _this = this;
        electron_1.ipcMain.on('login', function () { return __awaiter(_this, void 0, void 0, function () {
            var account;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Main.login()];
                    case 1:
                        account = _a.sent();
                        return [4 /*yield*/, Main.mainWindow.loadFile(path.join(__dirname, '../index.html'))];
                    case 2:
                        _a.sent();
