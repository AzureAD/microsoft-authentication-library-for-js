...
const authOptions = {
    ...
    authority: `https://login.microsoftonline.microsoft.${process.env.TLD}/${process.env.AZURE_TENANT_ID}`,
    knownAuthorities: [`https://login.microsoftonline.microsoft.${process.env.TLD}/${process.env.AZURE_TENANT_ID}`],
};

const clientCredentialRequestScopes = [`https://graph.microsoft.${process.env.TLD}/.default`];
