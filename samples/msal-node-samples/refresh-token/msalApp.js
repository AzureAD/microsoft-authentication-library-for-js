...
app.get('/', async (req, res, next) => {
    try {
        ...
        if (error instanceof msal.InteractionRequiredAuthError) {
                 ...
                 */
                diskCache.find({ upn: req.cookies.userId }, async (err, data) => {
                    try {
                        ...
                        /**
                         * API to add a new account to MSAL cache
                         * using an ID token and optionally a clientIfo string
                         */
                        await msalCache.addAccount({
