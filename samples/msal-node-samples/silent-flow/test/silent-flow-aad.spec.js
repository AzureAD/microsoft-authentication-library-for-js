...
describe("Silent Flow AAD PPE Tests", function () {
    jest.retryTimes(1);
    ...
    var username;
    var accountPwd;
    var screenshotFolder = "".concat(testUtils_1.SCREENSHOT_BASE_FOLDER_NAME, "/silent-flow/aad");
    ...
    describe("AcquireToken", function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, page.goto(homeRoute, { waitUntil: "networkidle0" })];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it("Performs acquire token silent", function () { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, screenshot.takeScreenshot(page, "ATS")];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, page.click("#acquireTokenSilent")];
                    case 5:
    ...
    describe("Get All Accounts", function () {
        describe("Authenticated", function () {
            ...
            it("Gets all cached accounts", function () { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
                ...
                return (0, tslib_1.__generator)(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, page.goto("".concat(homeRoute, "/allAccounts"), { waitUntil: "networkidle0" })];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, page.waitForSelector("#getAllAccounts")];
                        case 2:
...
//# sourceMappingURL=silent-flow-aad.spec.js.map