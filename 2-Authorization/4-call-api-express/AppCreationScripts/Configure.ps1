...
Function ConfigureApplications
{
   ...
   $clientAadApplication = New-MgApplication -DisplayName "ciam-msal-node-webapp" `
    ...
    $dictionary = @{ "Enter_the_Application_Id_Here" = $clientAadApplication.AppId;"Enter_the_Tenant_Info_Here" = $tenantId;"Enter_the_Client_Secret_Here" = $clientAppKey;"Enter_the_Web_Api_App_Id_Uri_Here" = $serviceIdentifierUri };
