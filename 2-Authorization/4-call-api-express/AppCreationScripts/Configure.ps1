...
Function ConfigureApplications
{
   ...
   $clientAadApplication = New-MgApplication -DisplayName "ciam-msal-node-webapp" `
    ...
    $dictionary = @{ "Enter the Client ID (aka 'Application ID')" = $serviceAadApplication.AppId;"Enter the tenant ID" = $tenantId; "Enter_the_Tenant_Name_Here" = $tenantName.Split(".onmicrosoft.com")[0]; };
