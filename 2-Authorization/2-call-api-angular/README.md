---
page_type: sample
name: Angular single-page application using MSAL Angular to authenticate users with Azure AD CIAM and call a protected ASP.NET Core web API
...
1. The client Angular SPA uses the  to sign-in a user and obtain a JWT [ID Token](https://aka.ms/id-tokens) and an [Access Token](https://aka.ms/access-tokens) from **Azure AD CIAM**.
