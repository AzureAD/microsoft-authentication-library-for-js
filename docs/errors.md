...
For framework-specific setup instructions (Angular, React, Next.js, Vite, Webpack), see the [COOP redirect bridge guide](../lib/msal-browser/docs/coop-redirect-bridge.md).
