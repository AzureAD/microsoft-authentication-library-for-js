...
describe('Msal', function (): any {
    ...
    var storageFake = function () {
        ...
        return {
            getItem: function (key: any, enableCookieStorage?: boolean) {
                if (enableCookieStorage) {
                    return this.getItemCookie(key);
                }
                return store[key];
            },
            setItem: function (key: any, value: any, enableCookieStorage?: boolean) {
    ...
    it('navigates user to login by default', (done) => {
        expect(msal._redirectUri).toBe("http://localhost:8080");
