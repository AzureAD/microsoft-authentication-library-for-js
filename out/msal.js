...
define("B2cAuthority", ["require", "exports", "AadAuthority", "Authority", "ErrorMessage", "Utils"], function (require, exports, AadAuthority_1, Authority_1, ErrorMessage_1, Utils_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var B2cAuthority = (function (_super) {
        ...
        function B2cAuthority(authority, validateAuthority) {
            ...
            var urlComponents = Utils_4.Utils.GetUrlComponents(authority);
...
define("Authority", ["require", "exports", "Utils", "ErrorMessage", "B2cAuthority", "AadAuthority", "XHRClient"], function (require, exports, Utils_5, ErrorMessage_2, B2cAuthority_1, AadAuthority_2, XHRClient_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var AuthorityType;
    ...
    var Authority = (function () {
        ...
        Object.defineProperty(Authority.prototype, "CanonicalAuthority", {
            ...
            set: function (url) {
                this.canonicalAuthority = Utils_5.Utils.CanonicalizeUri(url);
        ...
        Object.defineProperty(Authority.prototype, "CanonicalAuthorityUrlComponents", {
            get: function () {
                if (!this.canonicalAuthorityUrlComponents) {
                    this.canonicalAuthorityUrlComponents = Utils_5.Utils.GetUrlComponents(this.CanonicalAuthority);
                }
        ...
        Authority.prototype.validateAsUri = function () {
            ...
            try {
                ...
                throw ErrorMessage_2.ErrorMessage.invalidAuthorityType;
            }
            if (!components.Protocol || components.Protocol.toLowerCase() !== "https:") {
                throw ErrorMessage_2.ErrorMessage.authorityUriInsecure;
            }
            ;
            if (!components.PathSegments || components.PathSegments.length < 1) {
                throw ErrorMessage_2.ErrorMessage.authorityUriInvalidPath;
            }
        };
        Authority.DetectAuthorityFromUrl = function (authorityUrl) {
            authorityUrl = Utils_5.Utils.CanonicalizeUri(authorityUrl);
            var components = Utils_5.Utils.GetUrlComponents(authorityUrl);
...
define("AadAuthority", ["require", "exports", "Authority", "XHRClient"], function (require, exports, Authority_2, XHRClient_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var AadAuthority = (function (_super) {
        ...
        Object.defineProperty(AadAuthority.prototype, "AuthorityType", {
            get: function () {
                return Authority_2.AuthorityType.Aad;
            },
            enumerable: true,
            configurable: true
        });
        ...
        return AadAuthority;
    }(Authority_2.Authority));
    exports.AadAuthority = AadAuthority;
});
define("AccessTokenKey", ["require", "exports", "Utils"], function (require, exports, Utils_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var AccessTokenKey = (function () {
        function AccessTokenKey(authority, clientId, scopes, uid, utid) {
            ...
            this.scopes = scopes;
            this.userIdentifier = Utils_6.Utils.base64EncodeStringUrlSafe(uid) + "." + Utils_6.Utils.base64EncodeStringUrlSafe(utid);
        }
...
define("AuthenticationRequestParameters", ["require", "exports", "Utils"], function (require, exports, Utils_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var AuthenticationRequestParameters = (function () {
        function AuthenticationRequestParameters(authority, clientId, scope, responseType, redirectUri) {
            ...
            this.correlationId = Utils_7.Utils.createNewGuid();
            this.state = Utils_7.Utils.createNewGuid();
            this.nonce = Utils_7.Utils.createNewGuid();
            this.xClientSku = "MSAL.JS";
            this.xClientVer = Utils_7.Utils.getLibraryVersion();
        }
...
define("IInstanceDiscoveryResponse", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("Logger", ["require", "exports", "Utils"], function (require, exports, Utils_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var LogLevel;
    (function (LogLevel) {
    ...
    var Logger = (function () {
        ...
        Logger.prototype.logMessage = function (logMessage, logLevel, containsPii) {
            ...
            var log;
            if (!Utils_8.Utils.isEmpty(this.correlationId)) {
                log = timestamp + ":" + this._correlationId + "-" + Utils_8.Utils.getLibraryVersion() + "-" + LogLevel[logLevel] + " " + logMessage;
            }
            else {
                log = timestamp + ":" + Utils_8.Utils.getLibraryVersion() + "-" + LogLevel[logLevel] + " " + logMessage;
            }
...
define("Storage", ["require", "exports", "Constants", "AccessTokenCacheItem"], function (require, exports, Constants_1, AccessTokenCacheItem_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("UserAgentApplication", ["require", "exports", "AccessTokenKey", "AccessTokenValue", "AuthenticationRequestParameters", "Authority", "ClientInfo", "Constants", "IdToken", "RequestContext", "Storage", "RequestInfo", "User", "Utils"], function (require, exports, AccessTokenKey_1, AccessTokenValue_1, AuthenticationRequestParameters_1, Authority_3, ClientInfo_1, Constants_2, IdToken_1, RequestContext_1, Storage_1, RequestInfo_1, User_1, Utils_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var ResponseTypes = {
        id_token: "id_token",
    ...
    var UserAgentApplication = (function () {
        ...
        Object.defineProperty(UserAgentApplication.prototype, "authority", {
            ...
            set: function (val) {
                this.authorityInstance = Authority_3.Authority.CreateInstance(val, this.validateAuthority);
            },
            enumerable: true,
            configurable: true
        });
        UserAgentApplication.prototype.loginRedirect = function (scopes, extraQueryParameters) {
            ...
            if (scopes) {
                ...
                if (isValidScope && !Utils_9.Utils.isEmpty(isValidScope)) {
                    if (this._tokenReceivedCallback) {
            ...
            this.authorityInstance.ResolveEndpointsAsync()
                ...
                if (Utils_9.Utils.isEmpty(_this._cacheStorage.getItem(authorityKey))) {
        ...
        UserAgentApplication.prototype.loginPopup = function (scopes, extraQueryParameters) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                _this.authorityInstance.ResolveEndpointsAsync().then(function () {
                    ...
                    _this._cacheStorage.setItem(Constants_2.Constants.msalError, Constants_2.ErrorCodes.endpointResolutionError);
                    _this._cacheStorage.setItem(Constants_2.Constants.msalErrorDescription, Constants_2.ErrorDescription.endpointResolutionError);
                    if (reject) {
        ...
        UserAgentApplication.prototype.promptUser = function (urlNavigate) {
            if (urlNavigate && !Utils_9.Utils.isEmpty(urlNavigate)) {
        ...
        UserAgentApplication.prototype.openWindow = function (urlNavigate, title, interval, instance, resolve, reject) {
            ...
            if (popupWindow == null) {
                ...
                this._cacheStorage.setItem(Constants_2.Constants.msalError, Constants_2.ErrorCodes.popUpWindowError);
                this._cacheStorage.setItem(Constants_2.Constants.msalErrorDescription, Constants_2.ErrorDescription.popUpWindowError);
                if (reject) {
        ...
        UserAgentApplication.prototype.getCachedToken = function (authenticationRequest, user) {
            ...
            if (!authenticationRequest.authority) {
                for (var i = 0; i < tokenCacheItems.length; i++) {
                    ...
                    if (Utils_9.Utils.containsScope(cachedScopes, scopes)) {
                        filteredItems.push(cacheItem);
                    }
                }
                if (filteredItems.length === 1) {
                    accessTokenCacheItem = filteredItems[0];
                    authenticationRequest.authorityInstance = Authority_3.Authority.CreateInstance(accessTokenCacheItem.key.authority, this.validateAuthority);
                }
                    ...
                    authenticationRequest.authorityInstance = Authority_3.Authority.CreateInstance(authorityList[0], this.validateAuthority);
                }
            }
            else {
                for (var i = 0; i < tokenCacheItems.length; i++) {
                    var cacheItem = tokenCacheItems[i];
                    var cachedScopes = cacheItem.key.scopes.split(" ");
                    if (Utils_9.Utils.containsScope(cachedScopes, scopes) && cacheItem.key.authority === authenticationRequest.authority) {
                        filteredItems.push(cacheItem);
                    }
                }
            ...
            if (accessTokenCacheItem != null) {
                ...
                if (expired && (expired > Utils_9.Utils.now() + offset)) {
                    return {
                        errorDesc: null,
        ...
        UserAgentApplication.prototype.addHintParameters = function (urlNavigate, user) {
            ...
            var uid = Utils_9.Utils.base64DecodeStringUrlSafe(decodedClientInfo[0]);
            var utid = Utils_9.Utils.base64DecodeStringUrlSafe(decodedClientInfo[1]);
            if (userObject.displayableId && !Utils_9.Utils.isEmpty(userObject.displayableId)) {
                urlNavigate += '&login_hint=' + encodeURIComponent(user.displayableId);
            }
            if (!Utils_9.Utils.isEmpty(uid) && !Utils_9.Utils.isEmpty(utid)) {
                if (!this.urlContainsQueryStringParameter("domain_req", urlNavigate) && !Utils_9.Utils.isEmpty(utid)) {
                    urlNavigate += '&domain_req=' + encodeURIComponent(utid);
                }
                if (!this.urlContainsQueryStringParameter("login_req", urlNavigate) && !Utils_9.Utils.isEmpty(uid)) {
                    urlNavigate += '&login_req=' + encodeURIComponent(uid);
                }
                if (!this.urlContainsQueryStringParameter("domain_hint", urlNavigate) && !Utils_9.Utils.isEmpty(utid)) {
        ...
        UserAgentApplication.prototype.acquireTokenRedirect = function (scopes, authority, user, extraQueryParameters) {
            ...
            if (!userObject) {
                if (this._tokenReceivedCallback) {
                    this._tokenReceivedCallback(Constants_2.ErrorDescription.userLoginError, null, Constants_2.ErrorCodes.userLoginError, Constants_2.Constants.accessToken);
                    return;
                }
            }
            this._acquireTokenInProgress = true;
            var authenticationRequest;
            var acquireTokenAuthority = authority ? Authority_3.Authority.CreateInstance(authority, this.validateAuthority) : this.authorityInstance;
            acquireTokenAuthority.ResolveEndpointsAsync().then(function () {
                if (Utils_9.Utils.compareObjects(userObject, _this._user)) {
                ...
                if (Utils_9.Utils.isEmpty(_this._cacheStorage.getItem(acquireTokenUserKey))) {
        ...
        UserAgentApplication.prototype.acquireTokenPopup = function (scopes, authority, user, extraQueryParameters) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                var authenticationRequest;
                var acquireTokenAuthority = authority ? Authority_3.Authority.CreateInstance(authority, _this.validateAuthority) : _this.authorityInstance;
                var popUpWindow = _this.openWindow('about:blank', '_blank', 1, _this, resolve, reject);
                if (!popUpWindow) {
                    return;
                }
        ...
        UserAgentApplication.prototype.acquireTokenSilent = function (scopes, authority, user, extraQueryParameters) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                if (isValidScope && !Utils_9.Utils.isEmpty(isValidScope)) {
                    ...
                    var newAuthority = authority ? Authority_3.Authority.CreateInstance(authority, _this.validateAuthority) : _this.authorityInstance;
                    if (Utils_9.Utils.compareObjects(userObject_1, _this._user)) {
                        if (scopes.indexOf(_this.clientId) > -1) {
        ...
        UserAgentApplication.prototype.renewToken = function (scopes, resolve, reject, user, authenticationRequest, extraQueryParameters) {
            ...
            if (Utils_9.Utils.isEmpty(this._cacheStorage.getItem(acquireTokenUserKey))) {
                this._cacheStorage.setItem(acquireTokenUserKey, JSON.stringify(user));
            }
            var authorityKey = Constants_2.Constants.authority + Constants_2.Constants.resourceDelimeter + authenticationRequest.state;
            if (Utils_9.Utils.isEmpty(this._cacheStorage.getItem(authorityKey))) {
        ...
        UserAgentApplication.prototype.getUser = function () {
            ...
            if (!Utils_9.Utils.isEmpty(rawIdToken) && !Utils_9.Utils.isEmpty(rawClientInfo)) {
            ...
            if (tokenResponse.parameters.hasOwnProperty("scope")) {
                ...
                for (var i = 0; i < accessTokenCacheItems.length; i++) {
                    ...
                    if (accessTokenCacheItem.key.userIdentifier === user.userIdentifier) {
                        ...
                        if (Utils_9.Utils.isIntersectingScopes(cachedScopes, consentedScopes))
                ...
                var accessTokenValue = new AccessTokenValue_1.AccessTokenValue(tokenResponse.parameters[Constants_2.Constants.accessToken], idToken.rawIdToken, Utils_9.Utils.expiresIn(tokenResponse.parameters[Constants_2.Constants.expiresIn]).toString(), clientInfo);
                ...
                if (tokenResponse.stateMatch) {
                    ...
                    if (tokenResponse.parameters.hasOwnProperty(Constants_2.Constants.accessToken)) {
                        ...
                        if (!Utils_9.Utils.isEmpty(this._cacheStorage.getItem(authorityKey))) {
                            ...
                            authority = Utils_9.Utils.replaceFirstPath(authority, idToken.tenantId);
                        }
                        ...
                        if (!Utils_9.Utils.isEmpty(this._cacheStorage.getItem(acquireTokenUserKey))) {
                            ...
                            if (user && acquireTokenUser && Utils_9.Utils.compareObjects(user, acquireTokenUser)) {
        ...
        UserAgentApplication.prototype.isCallback = function (hash) {
            ...
            var parameters = Utils_9.Utils.deserialize(hash);
...
define("Telemetry", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
