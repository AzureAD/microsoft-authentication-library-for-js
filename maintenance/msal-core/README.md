...
[Complete details and best practices](https://github.com/AzureAD/microsoft-authentication-library-for-js/blob/dev/maintenance/msal-core/docs/cdn-usage.md) for CDN usage are available in our documentation.
