...
* IE11 support requires a Promise polyfill ([more information](https://github.com/AzureAD/microsoft-authentication-library-for-js/tree/msal-lts/samples/msal-core-samples/VanillaJSTestApp/app/ie11-sample/README.md) on IE11 support).
