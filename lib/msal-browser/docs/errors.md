...
This error occurs when MSAL.js surpasses the allotted storage limit attempting to save token information in the [configured cache storage](./caching.md#cache-storage).
