...
import { ValidCredentialType } from "@azure/msal-common/browser";
...
// src/controllers/StandardController.ts:423:8 - (tsdoc-param-tag-missing-hyphen) The @param block should be followed by a parameter name and then a hyphen
// src/controllers/StandardController.ts:1140:8 - (tsdoc-param-tag-missing-hyphen) The @param block should be followed by a parameter name and then a hyphen
...
// src/controllers/StandardController.ts:2247:8 - (tsdoc-param-tag-missing-hyphen) The @param block should be followed by a parameter name and then a hyphen
