...
1. [Why is getAccount returning null when filtering by username, even though I'm signed in?](#why-is-getaccount-returning-null-even-though-im-signed-in)
...
## Why is `getAccount` returning null when filtering by email, even though I'm signed in?
