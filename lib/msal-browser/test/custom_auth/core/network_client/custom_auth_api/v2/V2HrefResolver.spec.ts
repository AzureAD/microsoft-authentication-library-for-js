...
import { resolveHref } from "../../../../../../src/custom_auth/core/network_client/custom_auth_api/v2/V2HrefResolver.js";
import { ParsedUrlError } from "../../../../../../src/custom_auth/core/error/ParsedUrlError.js";

describe("V2HrefResolver.resolveHref", () => {
    ...
    it("strips the href tenant and re-anchors on the authority tenant path", () => {
        ...
        const result = resolveHref(base, href);
    ...
    it("produces the same result whether the authority has a trailing slash or not", () => {
        ...
        expect(resolveHref(withSlash, href).href).toBe(
            resolveHref(withoutSlash, href).href
        );
    });
