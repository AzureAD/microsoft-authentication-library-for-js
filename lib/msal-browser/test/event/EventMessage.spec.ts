...
describe("EventMessage.ts Unit Tests", () => {
    ...
    describe("getInteractionStatusFromEvent()", () => {
        ...
        it(
            "returns status AcquireToken with event type ACQUIRE_TOKEN_START and interaction type Popup",
            () => {
        ...
        it(
            "returns null with event type ACQUIRE_TOKEN_START and an interaction type that is not Popup or Redirect",
            () => {
                TEST_EVENT_MESSAGE.eventType = EventType.ACQUIRE_TOKEN_START;
        ...
        it(
            "returns status HandleRedirect with event type HANDLE_REDIRECT_START",
            () => {
        ...
        it(
            "returns status None with event type ACQUIRE_TOKEN_SUCCESS and interaction type redirect",
            () => {
        ...
        it(
            "returns null with event type ACQUIRE_TOKEN_FAILURE and an interaction type that is not popup or redirect",
            () => {
