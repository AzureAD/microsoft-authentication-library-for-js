...
describe("XhrClient.ts Unit Tests", () => {
    ...
    describe("Get requests", () => {
        it("sends a get request as expected", () => {
            ...
            sinon
                .stub(XMLHttpRequest.prototype, "open")
                .callsFake(
    ...
    describe("sendRequestAsync", () => {
        it("throws error if called with an unrecognized request type", async () => {
            ...
            try {
                ...
                const browserAuthError: BrowserAuthError =
                    e as BrowserAuthError;
                expect(
                    browserAuthError.errorMessage.includes(
        ...
        it("throws error if xhr post returns non-200 status", (done) => {
            ...
            xhrClient
                ...
                .catch((e) => {
                    ...
                    expect(
                        e.errorMessage.includes("Failed with status 16")
                    ).toBe(true);
                    done();
                });
        ...
        it("throws error if xhr get returns non-200 status", (done) => {
            ...
            xhrClient.sendGetRequestAsync<any>(targetUri).catch((e) => {
                ...
                expect(e.errorMessage.includes("Failed with status 16")).toBe(
                    true
                );
                done();
            });
        ...
        it("throws error if xhr post errors", (done) => {
            ...
            xhrClient
                ...
                .catch((e) => {
                    ...
                    expect(
                        e.errorMessage.includes("Failed with status 0")
                    ).toBe(true);
                    done();
                });
            testRequest!.error();
        ...
        it("throws error if xhr get errors", (done) => {
            ...
            xhrClient.sendGetRequestAsync<any>(targetUri).catch((e) => {
                ...
                expect(e.errorMessage.includes("Failed with status 0")).toBe(
                    true
                );
                done();
            });
