...
import { AccountInfo, AuthorizationCodeClient, BrokerAuthenticationResult, BrokerAuthorizationCodeClient, BrokerRefreshTokenClient, Constants, ProtocolUtils, RefreshTokenClient, RequestThumbprint, ScopeSet, ServerTelemetryManager } from "@azure/msal-common";
...
export class BrokerClientApplication extends ClientApplication {
    ...
    listenForBrokerMessage(): void {
        this.logger.verbose("Listening for messages");
