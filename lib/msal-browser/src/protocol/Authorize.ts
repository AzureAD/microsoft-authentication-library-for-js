 ...
 *
 * @param config - {Configuration} MSAL configuration.
 * @param request - {AuthCodeUrlRequest}. The caller supplies the PKCE
 * `codeChallenge` and keeps the matching verifier.
 * @param performanceClient - {IPerformanceClient} Optional performance client.
