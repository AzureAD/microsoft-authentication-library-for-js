...
export const BrowserAuthErrorMessage = {
    ...
    shrParametersMissing: {
        code: "shr_parameters_missing",
        desc: "Cannot set AuthenticationScheme to POP unless SHR parameters are defined, please refer aka.ms/msaljs/atpop"
    },
    shrGenerationError: {
        code: "shr_generation_error",
        desc: "SHR cannot be generated by native/msal js components, please check the log trace"
    },
};
...
export class BrowserAuthError extends AuthError {
    ...
    /**
     * Create an error when SHR parameters are missing from the POP request
     *
     */
    static createSHRParametersMissingError(): BrowserAuthError {
        return new BrowserAuthError(BrowserAuthErrorMessage.shrParametersMissing.code, BrowserAuthErrorMessage.shrParametersMissing.desc);
    }

    /**
     * Create an error when SHR cannot be generated by the native or the msal js components
     */
