...
export const hashDoesNotContainKnownPropertiesError =
...
export const userCancelledError = "user_cancelled";
export const monitorPopupTimeoutError = "monitor_popup_timeout";
export const monitorIframeTimeoutError = "monitor_window_timeout";
export const redirectInIframeError = "redirect_in_iframe";
export const blockTokenRequestsInHiddenIframeError = "block_iframe_reload";
export const blockAcquireTokenInPopupsError = "block_nested_popups";
export const iframeClosedPrematurelyError = "iframe_closed_prematurely";
export const silentLogoutUnsupportedError = "silent_logout_unsupported";
...
export const authRequestNotSet = "auth_request_not_set_error";
export const invalidCacheType = "invalid_cache_type";
export const notInBrowserEnvironment = "non_browser_environment";
...
export const failedToParseNetworkResponse = "failed_to_parse_response";
export const unableToLoadTokenError = "unable_to_load_token";
export const signingKeyNotFoundInStorage = "crypto_key_not_found";
