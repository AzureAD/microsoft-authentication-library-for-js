...
import { DatabaseStorage, DatabaseInfo } from "./DatabaseStorage";
...
export class AsyncMemoryStorage<T> implements IAsyncStorage<T> {
    ...
    constructor(tableName: DBTableNames, logger: Logger) {
        this.inMemoryCache = new MemoryStorage<T>();
        this.indexedDBCache = new DatabaseStorage<T>(INDEXED_DB_INFO, tableName);
        this.logger = logger;
    }
