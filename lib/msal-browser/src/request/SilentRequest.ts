...
import { CommonSilentFlowRequest, StringDict } from "@azure/msal-common";
 ...
 */
export type SilentRequest = Omit<CommonSilentFlowRequest, "authority"|"correlationId"|"forceRefresh"> & {
    redirectUri?: string;
