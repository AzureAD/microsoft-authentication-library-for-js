...
import type { V2SignInContinuationState } from "../state/V2SignInContinuationState.js";
 ...
 * automatically, so on success it surfaces `V2SignInContinuationState`
 ...
 * `V2SignInContinuationState` and carries no account data; the account is
