 ...
 * methods before a challenge can be issued.
 */
export class AuthenticationMethodSelectionRequiredState extends AuthFlowActionRequiredStateBase<AuthenticationMethodSelectionRequiredStateParameters> {
    ...
    /**
     * The authentication methods the user can choose from.
     */
    ...
    /**
     * Requests a challenge for the selected authentication method.
