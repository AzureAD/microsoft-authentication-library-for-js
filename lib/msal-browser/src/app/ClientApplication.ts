...
export abstract class ClientApplication {
    ...
    constructor(configuration: Configuration) {
        ...
        if (!this.isBrowserEnvironment) {
            this.browserStorage = new DefaultStorageClass();
            return;
        }
