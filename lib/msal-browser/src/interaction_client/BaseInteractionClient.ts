...
import { ICrypto, INetworkModule, Logger, AuthenticationResult, AccountInfo, AccountEntity, UrlString, AuthenticationScheme, BaseAuthRequest } from "@azure/msal-common";
