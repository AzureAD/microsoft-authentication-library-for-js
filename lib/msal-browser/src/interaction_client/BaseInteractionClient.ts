...
export abstract class BaseInteractionClient {
    ...
    protected async getDiscoveredAuthority(requestAuthority?: string): Promise<Authority> {
        ...
        if (requestAuthority) {
            ...
            return await AuthorityFactory.createDiscoveredInstance(this.logger, requestAuthority, this.config.system.networkClient, this.browserStorage, authorityOptions);
        }

        this.logger.verbose("Creating discovered authority with configured authority");
        return await AuthorityFactory.createDiscoveredInstance(this.logger, this.config.auth.authority, this.config.system.networkClient, this.browserStorage, authorityOptions);
    }
}
