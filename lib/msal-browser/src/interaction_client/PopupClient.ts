...
export class PopupClient extends StandardInteractionClient {
    ...
    private trackPageVisibility():void {
        console.log("track page vis");
        this.logger.info("tp: tracking page vis");
        /*
         *  add visibily change
         * add static field
         */

        console.log("openPopup:",this.openPopupMeasurement);
    ...
    /*
     * test: mock perf client
     * if open popup is not called, it should not add the meas
     */
