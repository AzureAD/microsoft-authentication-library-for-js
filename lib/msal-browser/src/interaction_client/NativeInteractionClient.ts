        ...
        return this.handleNativeResponse(validatedResponse, nativeRequest, reqTimestamp)
            .then((result: AuthenticationResult) => {
                nativeATMeasurement.endMeasurement({
                    ...
                    mats_broker_version: mats ? mats.broker_version : undefined,
                    mats_account_join_on_start: mats ? mats.account_join_on_start : undefined,
                    mats_account_join_on_end: mats ? mats.account_join_on_end : undefined,
                    mats_device_join: mats ? mats.device_join : undefined,
                    mats_prompt_behavior: mats ? mats.prompt_behavior : undefined,
                    mats_api_error_code: mats ? mats.api_error_code : undefined,
                    mats_ui_visible: mats ? mats.ui_visible : undefined,
                    mats_silent_code: mats ? mats.silent_code : undefined,
                    mats_silent_bi_sub_code: mats ? mats.silent_bi_sub_code : undefined,
                    mats_silent_message: mats ? mats.silent_message : undefined,
                    mats_silent_status: mats ? mats.silent_status : undefined,
                    mats_http_status: mats ? mats.http_status : undefined,
                    mats_http_event_count: mats ? mats.http_event_count : undefined
                });
                return result;
            })
