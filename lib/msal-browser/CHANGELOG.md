...
<!-- This log was last generated on Wed, 18 Mar 2026 17:23:40 GMT and should not be manually modified. -->

<!-- Start content -->

## 4.30.0

Wed, 18 Mar 2026 17:23:40 GMT
...
- Bump @azure/msal-common to v15.17.0
...
- Add missing client capabilities in platform broker flows [#8429](https://github.com/AzureAD/microsoft-authentication-library-for-js/pull/8429) (lalimasharda@microsoft.com)
...
- Bump @azure/msal-common to v15.16.1
- Bump eslint-config-msal to v0.0.0
- Bump msal-test-utils to v0.0.1
- Bump rollup-msal to v0.0.0
...
- Add silentRefreshReason telemetry field to PerformanceEvent #8343 (kshabelko@microsoft.com)
- Bump @azure/msal-common to v15.15.0
- Bump eslint-config-msal to v0.0.0
- Bump msal-test-utils to v0.0.1
- Bump rollup-msal to v0.0.0
...
- Verify if an app is SSO Capable, [#8252](https://github.com/AzureAD/microsoft-authentication-library-for-js/pull/8252)  (sameera.gajjarapu@microsoft.com)
