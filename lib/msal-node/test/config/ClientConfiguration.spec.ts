...
import { Authority, AuthorityFactory, LogLevel, NetworkRequestOptions, AuthToken, AzureCloudInstance, Constants } from '@azure/msal-common';
...
describe('ClientConfiguration tests', () => {
    test('builds configuration and assigns default functions', () => {
        ...
        expect(config.auth.azureCloudInstance).toEqual(AzureCloudInstance.None);
        expect(config.auth.tenant).toEqual(Constants.DEFAULT_TENANT);
