...
describe.skip("Serializer test cases", () => {
    ...
    test("serializeAccountCacheEntity", () => {
        ...
        expect(serializedAcc[MockCache.accKey]).toEqual(jsonCache.Account[MockCache.accKey]);
    });
    ...
    test("serializeIdTokenCacheEntity", () => {
        ...
        expect(serializedIdT[MockCache.idTKey]).toEqual(jsonCache.IdToken[MockCache.idTKey]);
    });
    ...
    test("serializeAccessTokenEntity", () => {
        ...
        expect(serializedAt[MockCache.atOneKey]).toEqual(jsonCache.AccessToken[MockCache.atOneKey]);
    });
    ...
    test("serializeRefreshTokenCacheEntity", () => {
        ...
        expect(serializedRT[MockCache.rtKey]).toEqual(jsonCache.RefreshToken[MockCache.rtKey]);
    });
    ...
    test("serializeAppMetadataCacheEntity", () => {
        ...
        expect(serializedAmdt[MockCache.amdtKey]).toEqual(jsonCache.AppMetadata[MockCache.amdtKey]);
    });
    ...
    test("serializeAll", () => {
        ...
        expect(jCache.Account[MockCache.accKey]).toEqual(jsonCache.Account[MockCache.accKey]);
        expect(jCache.IdToken[MockCache.idTKey]).toEqual(jsonCache.IdToken[MockCache.idTKey]);
        expect(jCache.AccessToken[MockCache.atOneKey]).toEqual(jsonCache.AccessToken[MockCache.atOneKey]);
        expect(jCache.AccessToken[MockCache.atTwoKey]).toEqual(jsonCache.AccessToken[MockCache.atTwoKey]);
        expect(jCache.RefreshToken[MockCache.rtKey]).toEqual(jsonCache.RefreshToken[MockCache.rtKey]);
        expect(jCache.RefreshToken[MockCache.rtFKey]).toEqual(jsonCache.RefreshToken[MockCache.rtFKey]);
        expect(jCache.AppMetadata[MockCache.amdtKey]).toEqual(jsonCache.AppMetadata[MockCache.amdtKey]);
    });
});
