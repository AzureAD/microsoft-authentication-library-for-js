...
// the following command was run to generate a PEM and private key:
// openssl req -newkey rsa:2048 -new -nodes -x509 -days 3650 -keyout key.pem -out cert.pem
// the only value entered in the prompts was "US", when asked for "Country Name"
export const CLIENT_CERTIFICATE = {
    PEM_CERT: `-----BEGIN CERTIFICATE-----

XBzzadri2sFWCrzww9AnX1EWAgW/jGiXXWj6MPEikRnuhmXms6JH/mns
-----END CERTIFICATE-----
`,
    PRIVATE_KEY: `-----BEGIN PRIVATE KEY-----

-----END PRIVATE KEY-----
`,
};
