...
export const CAE_CONSTANTS = {
    ...
    EMPTY_CLAIMS: "{}",
    MERGED_EMPTY_CLAIMS: `{${DEFAULT_ID_TOKEN_CLAIMS},"access_token":{${XMS_CC_CLAIM}}}`,
    CLAIMS_WITH_ADDITIONAL_CLAIMS: `{"access_token":{${NBF_CLAIM},${ADDITIONAL_CLAIM}}}`,
    MERGED_CLAIMS_WITH_ADDITIONAL_CLAIMS: `{"access_token":{${NBF_CLAIM},${ADDITIONAL_CLAIM},${XMS_CC_CLAIM}},${DEFAULT_ID_TOKEN_CLAIMS}}`,
    ...
    MERGED_CLAIMS_WITH_ADDITIONAL_KEY: `{"access_token":{${NBF_CLAIM},${ADDITIONAL_CLAIM},${NEW_CLAIM},${XMS_CC_CLAIM}},"some_other_key":{${NBF_CLAIM},${ADDITIONAL_CLAIM},${NEW_CLAIM}},${DEFAULT_ID_TOKEN_CLAIMS}}`,
    ...
    MERGED_CLAIM_WITH_ADDITIONAL_KEY_AND_ACCESS_KEY: `{"some_other_key":{${NBF_CLAIM},${ADDITIONAL_CLAIM},${NEW_CLAIM}},"access_token":{${NBF_CLAIM},${ADDITIONAL_CLAIM},${NEW_CLAIM},${XMS_CC_CLAIM}},${DEFAULT_ID_TOKEN_CLAIMS}}`,
};
