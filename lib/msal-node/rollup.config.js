...
export default [
    {
        input: ["src/index.ts", "src/confidential/index.ts"],
        output: {
            dir: "dist",
            format: "es",
    ...
    {
        input: "src/confidential/index.ts",
        output: {
            dir: "lib/confidential",
            format: "cjs",
            entryFileNames: "msal-node-confidential.cjs",
            banner: fileHeader,
            sourcemap: true,
        },
        treeshake: {
