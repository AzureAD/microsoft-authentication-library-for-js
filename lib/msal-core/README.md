...
MSAL.js supports [conditional access scenarios](https://docs.microsoft.com/en-us/azure/active-directory/develop/msal-handling-exceptions#javascript) enabled in Azure AD. You may also [request additional claims]() for your application. Please review the linked MSAL Wiki pages. To understand more about how to enable conditional access for your application, or common conditional access scenarios, please review the docs [here](https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/overview).
