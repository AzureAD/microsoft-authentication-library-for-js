...
```
```html
<script type="text/javascript" src="https://alcdn.msauth.net/lib/1.3.3/js/msal.min.js"></script>
````

#### Alternate region URLs (Europe region)
```html
<script type="text/javascript" src="https://alcdn.msftauth.net/lib/1.3.3/js/msal.js"></script>
```
```html
...
```html
<script type="text/javascript" src="https://alcdn.msauth.net/lib/1.3.3/js/msal.js" integrity="sha384-NXrqATyZkIFf34YAQc9KUsELNnChm0YXI0Hugq92c2abTH1Gv7He1R/t89iGIAJn" crossorigin="anonymous"></script>
```
```html
<script type="text/javascript" src="https://alcdn.msauth.net/lib/1.3.3/js/msal.min.js" integrity="sha384-36I7QTFSxEfBGkSBpZ3zdySjtmAchWxrUHUFcLzDJVLe4dGnEwnOmp0vRfA1lek+" crossorigin="anonymous"></script>
```
