...
describe("TelemetryManager", () => {
    ...
    it("TelemetryManager - TelemetryEvent can have be created, add multiple events, and get it", done => {
        const config: TelemetryConfig = {
            clientId: TEST_CLIENT_ID,
            platform: TEST_PLATFORM,
            onlySendFailureTelemetry: false
    ...
    it("TelemetryManager - TelemetryEvent can be created, add an event, and get it without it being stopped", done => {
        const config: TelemetryConfig = {
            clientId: TEST_CLIENT_ID,
            platform: TEST_PLATFORM,
            onlySendFailureTelemetry: false
