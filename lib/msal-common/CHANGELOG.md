...
<!-- This log was last generated on Mon, 09 Mar 2026 22:21:39 GMT and should not be manually modified. -->

<!-- Start content -->

## 15.16.1

Mon, 09 Mar 2026 22:21:39 GMT
...
- Add interrupted user to interaction required list [#8323](https://github.com/AzureAD/microsoft-authentication-library-for-js/pull/8323) (hemoral@microsoft.com)
...
- Add new authority metadata [#8306](https://github.com/AzureAD/microsoft-authentication-library-for-js/pull/8306) (hemoral@microsoft.com)
- Bump eslint-config-msal to v0.0.0
- Bump msal-test-utils to v0.0.1
- Bump rollup-msal to v0.0.0
