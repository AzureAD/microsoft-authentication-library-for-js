...
export default [
    {
        ...
        plugins: [
            ...
            createCjsTypeShims({
                ...
                shims: [
                    {
                        filePath: path.join("dist", "index.d.cts"),
                        target: "./index.mjs",
                    },
                    {
                        filePath: path.join("dist", "index-node.d.cts"),
                        target: "./index-node.mjs",
                    },
                    {
                        filePath: path.join("dist-browser", "index-browser.d.cts"),
                        target: "./index-browser.mjs",
                    },
                ],
            }),
        ]
