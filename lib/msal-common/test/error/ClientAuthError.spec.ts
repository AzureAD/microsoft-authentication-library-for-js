...
describe("ClientAuthError.ts Class Unit Tests", () => {
    ...
    it("createClientInfoEmptyError creates a ClientAuthError object", () => {
        const err: ClientAuthError =
            ClientAuthError.createClientInfoEmptyError();
    ...
    it("createIdTokenParsingError creates a ClientAuthError object", () => {
        const err: ClientAuthError =
            ClientAuthError.createTokenParsingError("Raw client info.");
        ...
        expect(
            err.message.includes(ClientAuthErrorMessage.tokenParsingError.desc)
        ).toBe(true);
        expect(err.name).toBe("ClientAuthError");
        expect(err.stack?.includes("ClientAuthError.spec.ts")).toBe(true);
    });
    ...
    it("createIdTokenNullOrEmptyError creates a ClientAuthError object", () => {
        const err: ClientAuthError =
            ClientAuthError.createTokenNullOrEmptyError(
                "Invalid Raw IdToken string."
            );
        ...
        expect(
            err.message.includes(ClientAuthErrorMessage.nullOrEmptyToken.desc)
        ).toBe(true);
        expect(err.name).toBe("ClientAuthError");
        expect(err.stack?.includes("ClientAuthError.spec.ts")).toBe(true);
    });
    ...
    it("createEndpointDiscoveryIncompleteError creates a ClientAuthError object", () => {
        const err: ClientAuthError =
            ClientAuthError.createEndpointDiscoveryIncompleteError(
                "Test endpoint error."
            );
    ...
    it("createHashNotDeserializedError creates a ClientAuthError object", () => {
        const err: ClientAuthError =
            ClientAuthError.createHashNotDeserializedError(
                "Couldn't deserialize hash object correctly"
            );
        ...
        expect(
            err.errorMessage.includes(
                ClientAuthErrorMessage.hashNotDeserialized.desc
            )
        ).toBe(true);
        expect(
            err.message.includes(
    ...
    it("createStateMismatchError creates a ClientAuthError object", () => {
        ...
        expect(
            err.message.includes(ClientAuthErrorMessage.stateMismatchError.desc)
        ).toBe(true);
        expect(err.name).toBe("ClientAuthError");
        expect(err.stack?.includes("ClientAuthError.spec.ts")).toBe(true);
    });
    ...
    it("createNonceMismatchError creates a ClientAuthError object", () => {
        ...
        expect(
            err.message.includes(ClientAuthErrorMessage.nonceMismatchError.desc)
        ).toBe(true);
        expect(err.name).toBe("ClientAuthError");
        expect(err.stack?.includes("ClientAuthError.spec.ts")).toBe(true);
    });
    ...
    it("createAppendEmptyScopeToSetError creates a ClientAuthError object", () => {
        const err: ClientAuthError =
            ClientAuthError.createAppendEmptyScopeToSetError("");
        ...
        expect(
            err.errorMessage.includes(
                ClientAuthErrorMessage.appendEmptyScopeError.desc
            )
        ).toBe(true);
        expect(
            err.message.includes(
    ...
    it("createRemoveEmptyScopeFromSetError creates a ClientAuthError object", () => {
        const err: ClientAuthError =
            ClientAuthError.createRemoveEmptyScopeFromSetError("");
    ...
    it("createAppendScopeSetError creates a ClientAuthError object", () => {
        const err: ClientAuthError = ClientAuthError.createAppendScopeSetError(
            "Couldn't append scopeset"
        );
    ...
    it("createEmptyInputScopeSetError creates a ClientAuthError object", () => {
        const err: ClientAuthError =
            ClientAuthError.createEmptyInputScopeSetError();
    ...
    it("createDeviceCodeExpiredError creates a ClientAuthError object", () => {
        ...
        expect(
            err.message.includes(ClientAuthErrorMessage.DeviceCodeExpired.desc)
        ).toBe(true);
        expect(err.name).toBe("ClientAuthError");
        expect(err.stack?.includes("ClientAuthError.spec.ts")).toBe(true);
    });
    ...
    it("createInvalidCacheTypeError creates a ClientAuthError object", () => {
        const err: ClientAuthError =
            ClientAuthError.createInvalidCacheTypeError();
        ...
        expect(
            err.message.includes(ClientAuthErrorMessage.invalidCacheType.desc)
        ).toBe(true);
        expect(err.name).toBe("ClientAuthError");
        expect(err.stack?.includes("ClientAuthError.spec.ts")).toBe(true);
    });
    ...
    it("createUnexpectedAccountTypeError creates a ClientAuthError object", () => {
        const err: ClientAuthError =
            ClientAuthError.createUnexpectedAccountTypeError();
    ...
    it("createBindingKeyNotRemovedError creates a ClientAuthError object", () => {
        const err: ClientAuthError =
            ClientAuthError.createBindingKeyNotRemovedError();
    ...
    it("createLogoutNotSupportedError creates a ClientAuthError object", () => {
        ...
        expect(
            err.message.includes(ClientAuthErrorMessage.logoutNotSupported.desc)
        ).toBe(true);
        expect(err.name).toBe("ClientAuthError");
        expect(err.stack?.includes("ClientAuthError.spec.ts")).toBe(true);
    });
