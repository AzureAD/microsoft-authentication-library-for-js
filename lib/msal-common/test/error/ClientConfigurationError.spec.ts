...
describe("ClientConfigurationError.ts Class Unit Tests", () => {
    it("ClientConfigurationError object can be created", () => {
        ...
        const err: ClientConfigurationError = new ClientConfigurationError(
            TEST_ERROR_CODE,
            TEST_ERROR_MSG
        );
        ...
        expect(err.stack?.includes("ClientConfigurationError.spec.ts")).toBe(
            true
        );
    });
    ...
    it("createClaimsRequestParsingError creates a ClientConfigurationError object", () => {
        ...
        expect(
            err.errorMessage.includes(
                ClientConfigurationErrorMessage.claimsRequestParsingError.desc
            )
        ).toBe(true);
        expect(
            err.message.includes(
    ...
    it("createUrlParseError creates a ClientConfigurationError object", () => {
        ...
        expect(
            err.errorMessage.includes(
                ClientConfigurationErrorMessage.urlParseError.desc
            )
        ).toBe(true);
        expect(
            err.message.includes(
    ...
    it("createClientIdSingleScopeError creates a ClientConfigurationError object", () => {
        ...
        expect(
            err.errorMessage.includes(
                ClientConfigurationErrorMessage.clientIdSingleScopeError.desc
            )
        ).toBe(true);
        expect(
            err.message.includes(
    ...
    it("createInvalidPromptError creates a ClientConfigurationError object", () => {
        ...
        expect(
            err.errorMessage.includes(
                ClientConfigurationErrorMessage.invalidPrompt.desc
            )
        ).toBe(true);
        expect(
            err.message.includes(
