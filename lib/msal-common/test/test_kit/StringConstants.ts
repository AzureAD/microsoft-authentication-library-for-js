...
export const TEST_CONFIG = {
    ...
    CLOUD_DISCOVERY_METADATA:
        '{"tenant_discovery_endpoint":"https://login.microsoftonline.com/common/v2.0/.well-known/openid-configuration","api-version":"1.1","metadata":[{"preferred_network":"login.microsoftonline.com","preferred_cache":"login.windows.net","aliases":["login.microsoftonline.com","login.windows.net","login.microsoft.com","sts.windows.net"]},{"preferred_network":"login.partner.microsoftonline.cn","preferred_cache":"login.partner.microsoftonline.cn","aliases":["login.partner.microsoftonline.cn","login.chinacloudapi.cn"]},{"preferred_network":"login.microsoftonline.de","preferred_cache":"login.microsoftonline.de","aliases":["login.microsoftonline.de"]},{"preferred_network":"login.microsoftonline.us","preferred_cache":"login.microsoftonline.us","aliases":["login.microsoftonline.us","login.usgovcloudapi.net"]},{"preferred_network":"login-us.microsoftonline.com","preferred_cache":"login-us.microsoftonline.com","aliases":["login-us.microsoftonline.com"]},{"preferred_network":"login.sovcloud-identity.fr","preferred_cache":"login.sovcloud-identity.fr","aliases":["login.sovcloud-identity.fr"]},{"preferred_network":"login.sovcloud-identity.de","preferred_cache":"login.sovcloud-identity.de","aliases":["login.sovcloud-identity.de"]},{"preferred_network":"login.sovcloud-identity.sg","preferred_cache":"login.sovcloud-identity.sg","aliases":["login.sovcloud-identity.sg"]}]}',
};
