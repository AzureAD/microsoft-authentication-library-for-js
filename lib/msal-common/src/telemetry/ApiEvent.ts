...
export default class ApiEvent extends TelemetryEvent {
    ...
    constructor(eventId: string, correlationId: string, piiEnabled: boolean, apiEventIdentifier?: API_EVENT_IDENTIFIER) {
        super(eventId, prependEventNamePrefix("api_event"), correlationId, apiEventIdentifier);
