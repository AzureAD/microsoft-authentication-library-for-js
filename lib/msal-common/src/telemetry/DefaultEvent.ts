...
export default class DefaultEvent extends TelemetryEvent {
    // TODO Platform Type
    constructor(eventId: string, platform: TelemetryPlatform, correlationId: string, clientId: string, eventCount: EventCount) {
        super(eventId, prependEventNamePrefix("default_event"), correlationId, "DefaultEvent");
