...
export default class HttpEvent extends TelemetryEvent {
    ...
    constructor(eventId: string, correlationId: string, eventLabel: string) {
        super(eventId, prependEventNamePrefix("http_event"), correlationId, eventLabel);
    }
    ...
    public set queryParams(queryParams: any) {
        this.event[EVENT_KEYS.QUERY_PARAMETERS] = ServerCodeRequestParameters.generateQueryParametersString(queryParams);
    }
