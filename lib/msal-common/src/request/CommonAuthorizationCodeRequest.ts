...
/**
 * Request object passed by user to acquire a token from the server exchanging a valid authorization code 
 ...
 * - redirectUri             - The redirect URI of your app, where the authority will redirect to after the user inputs 
 *                              credentials and consents. It must exactly match one of the redirect URIs you 
