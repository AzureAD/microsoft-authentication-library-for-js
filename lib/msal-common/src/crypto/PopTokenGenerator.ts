...
export class PopTokenGenerator {
    ...
    async signPopToken(accessToken: string, resourceRequestMethod: string, resourceRequestUri: string, clientClaims?: string): Promise<string> {
        ...
        return await this.cryptoUtils.signJwt({
            ...
            client_claims: clientClaims || undefined
        }, tokenClaims.cnf.kid);
    }
}
