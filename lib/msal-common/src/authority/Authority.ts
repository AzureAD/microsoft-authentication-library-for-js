...
export class Authority {
    ...
    private matchesCiamTenantPattern(
        ...
        // PathSegments[0] (not [1]) is the first path segment of the *authority
        ...
        // Strip any trailing slashes from the issuer before comparing.
        // The patterns are generated by this method and never contain trailing
        // slashes, so only the issuer side needs normalization.
