...
export type CredentialEntity = {
    ...
    keyId?: string;
    /** Additional cache key components for cache isolation (e.g., { fmi_path: "..." }). Stored as raw key-value pairs; the hash is computed at key-generation time and passed explicitly to generateCredentialKey. */
