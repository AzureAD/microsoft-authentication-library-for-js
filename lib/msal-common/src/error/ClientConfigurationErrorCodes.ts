...
export const missingDpopResourceRequestMethod =
    "missing_dpop_resource_request_method";
export const missingDpopResourceRequestUri = "missing_dpop_resource_request_uri";
export const invalidDpopResourceRequest = "invalid_dpop_resource_request";
