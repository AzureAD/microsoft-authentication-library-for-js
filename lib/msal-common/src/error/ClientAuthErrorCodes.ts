...
export const blankGuidGenerated = "blank_guid_generated";
...
export const nonceNotFound = "nonce_not_found";
...
export const cannotAppendEmptyScope = "cannot_append_empty_scope";
...
export const noCachePlugin = "no_cache_plugin";
export const noCryptoObject = "no_crypto_object";
export const invalidCacheType = "invalid_cache_type";
export const unexpectedAccountType = "unexpected_account_type";
...
export const noAzureRegionDetected = "no_azure_region_detected";
export const accessTokenEntityNull = "access_token_entity_null";
