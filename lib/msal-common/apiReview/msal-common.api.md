...
function addResponseMode(
    parameters: Map<string, string>,
    responseMode?: Constants_2.ResponseMode
): void;
...
//
// @public
function addResponseType(
    parameters: Map<string, string>,
    responseType: Constants_2.OAuthResponseType
): void;
...
declare namespace AuthErrorCodes {
    export { unexpectedError, postRequestFailed };
}
...
//
// @public (undocumented)
const AuthorityGetCloudDiscoveryMetadataFromNetwork =
...
//
// @public (undocumented)
const AuthorityGetEndpointMetadataFromNetwork =
...
//
// @public (undocumented)
const AuthorityUpdateCloudDiscoveryMetadata =
...
//
// @public (undocumented)
const AuthorityUpdateMetadataWithRegionalInformation =
...
//
// @public (undocumented)
const AuthorizationCodeClientExecutePostToTokenEndpoint =
...
declare namespace AuthToken {
    export { extractTokenClaims, isKmsi, getJWSPayload, checkMaxAge };
}
export { AuthToken };
...
declare namespace CacheErrorCodes {
    export { cacheQuotaExceeded, cacheErrorUnknown };
}
...
//
// @public (undocumented)
const invalidPlatformBrokerConfiguration =
...
//
// @internal
export const invoke: <T extends any[], U>(
    callback: (...args: T) => U,
    eventName: string,
    logger: Logger,
...
//
// @internal
export const invokeAsync: <T extends any[], U>(
...
declare namespace ProtocolUtils {
    export { setRequestState, generateLibraryState, parseRequestState };
}
...
//
// @public
const RefreshTokenClientCreateTokenRequestBody =
    "refreshTokenClientCreateTokenRequestBody";
...
//
// @public
function sendPostRequest<T extends ServerAuthorizationTokenResponse>(
    thumbprint: RequestThumbprint,
    tokenEndpoint: string,
    options: NetworkRequestOptions,
    correlationId: string,
...
//
// @public (undocumented)
const SilentFlowClientGenerateResultFromCacheRecord =
    "silentFlowClientGenerateResultFromCacheRecord";
