...
// src/telemetry/performance/PerformanceEvent.ts:245:21 - (tsdoc-escape-right-brace) The "}" character should be escaped using a backslash to avoid confusion with a TSDoc inline tag
