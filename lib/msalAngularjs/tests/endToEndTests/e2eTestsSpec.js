...
describe('E2E tests', function () {
    ...
    var spec1 = it('Should login using redirect flow and logout', function () {
        logging.log(spec1.description, false);
        logging.log("Start of Test");
        browser.sleep(3000);
        signInModule.login().then(function () {
            return signInModule.enterCredentials(config.assignedUser, config.password);
        }).then(function () {
    ...
    var spec2 = it('Should login using Popup and logout', function () {
    ...
    var spec3 = it('Should login using redirect flow, navigate to Todo page (external API) and check if token is served from the cache', function () {
    ...
    var spec4 = it('Should login using redirect flow, navigate to Calendar page (Graph API) and check if token is served from the cache', function () {
    ...
    var spec5 = it('Should login using redirect flow, remove expiration key for todo api access_token to 0, navigate to Todo page and check if token is renewed using iframe', function () {
    ...
    var spec6 = it('Should navigate to TodoPage without signing in and check if user is prompted for login followed by acquire token request to Todo api to retrieve an access_token', function () {
    ...
    var spec7 = it('Should save some state (text) on the Home page, login using popup window and check if the Home page is not reloaded and state is retained', function () {
