...
app.config(['$httpProvider', '$routeProvider', 'msalAuthenticationServiceProvider','$locationProvider', function ($httpProvider, $routeProvider, msalAuthenticationServiceProvider, $locationProvider) {
