...
describe('TaskCtl', function () {
    ...
    it('tests errorResponse broadcast when login is in progress', function () {
        msalServiceProvider.getCachedToken = function () {
            return '';
        };
    ...
    //it('tests acquireTokenFailure broadcast event', function () {
    //    var errorResolve = 'login_progress_error|Login is in progress';
    //    var acquireTokenPopup = window.msal.acquireTokenPopup;
    //    window.msal.acquireTokenPopup = function () {
    //        return q.reject(errorResolve);
    //    };
