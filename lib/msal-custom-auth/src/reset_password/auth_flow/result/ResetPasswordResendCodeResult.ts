...
> {
     ...
     */
    isFailed(): this is ResetPasswordResendCodeResult & { state: ResetPasswordFailedState } {
     ...
     */
    isCodeRequired(): this is ResetPasswordResendCodeResult & { state: ResetPasswordCodeRequiredState } {
        /*
