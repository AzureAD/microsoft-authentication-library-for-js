...
> {
    ...
    /**
     * Creates a SignInResult instance with error details when an exception thrown during sign-in.
     * @param {unknown} error
     * @returns {SignInResult} The SignInResult instance with a CustomAuthError error and failed state.
     */
