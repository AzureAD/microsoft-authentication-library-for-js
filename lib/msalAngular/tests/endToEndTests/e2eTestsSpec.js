...
describe('E2ETests MSAL Angular', function () {
    ...
    var spec12 = it('Should login using redirect flow, remove expiration key for todo api access_token to 0, navigate to Todo page and check if token is renewed using iframe', function () {
