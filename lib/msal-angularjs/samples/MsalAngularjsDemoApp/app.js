...
window.applicationConfig = {
    ...
    webApiScope: ['api://a88bb933-319c-41b5-9f04-eff36d985612/access_as_user'],
    userProfileEndpoint: "https://graph.microsoft.com/v1.0/me",
    userProfileScopes: ["user.read"],
};

var map = new Map();
map.set(applicationConfig.webApiEndpoint, applicationConfig.webApiScope);
map.set(applicationConfig.userProfileEndpoint, applicationConfig.userProfileScopes);
