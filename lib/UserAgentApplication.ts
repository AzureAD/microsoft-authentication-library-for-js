...
namespace Msal {
    ...
    */
    ...
    export class UserAgentApplication {
        ...
        * @param {string} cache - location where the MSAL cache is stored
        */
        ...
        */
        ...
        /**
        * The client ID of the application, this should come from the application registration portal
        */
        clientId: string;
        ...
        * - In Azure B2C, it is of the form https://&lt;instance&gt;/tfp/&lt;tenant&gt;/<policyName>/v2.0/
        ...
        */
        ...
        /**
        * @callback {tokenReceivedCallback} - This is the function called after the request to loginRedirect or acquireTokenRedirect API is completed (either successfully or with a failure).
        * @param {string} token token returned from the Secure token service (STS) if API call is successful.
        * @param {string} tokenType tokenType returned from the STS if API call is successful. Possible values are: id_token OR access_token.
        * @param {string} error error message returned from the STS if API call fails.
        * @param {string} error_description error description returned from the STS if API call fails.
        */
        ...
        * - In Azure B2C, it is of the form https://&lt;instance&gt;/tfp/&lt;tenantId&gt;/&lt;policyName&gt;/v2.0/
        * - Default value is: "https://login.microsoftonline.com/common"
        * @param {tokenReceivedCallback} callback -  The function that will get the call back once this API is completed (either successfully or with a failure).
        ...
        */
        ...
        /**
        * Used to add the developer requested callback to the array of callbacks for the specified resource. The updated array is stored on the window object
        ...
        */
        ...
        /**
        * Used to get token for the specified resource from the cache
       ...
       */
        ...
        */
        ...
        /**
         * Returns the signed in user (received from a user object returned in a previous acquireToken call) or null.
         */
        getUser(): User {
