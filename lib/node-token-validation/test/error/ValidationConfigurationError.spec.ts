...
describe("ValidationConfigurationError", () => {
    it("ValidationError object can be created", () => {
        ...
        const err: ValidationConfigurationError =
            new ValidationConfigurationError(
                TEST_ERROR_CODE,
                TEST_ERROR_MESSAGE
            );
        ...
        expect(
            err.stack?.includes("ValidationConfigurationError.spec.ts")
        ).toBe(true);
    });
    ...
    it("createEmptyIssuerError creates a ValidationConfigurationError object", () => {
        const err: ValidationConfigurationError =
            ValidationConfigurationError.createEmptyIssuerError();
    ...
    it("createEmptyAudienceError creates a ValidationConfigurationError object", () => {
        const err: ValidationConfigurationError =
            ValidationConfigurationError.createEmptyAudienceError();
    ...
    it("createInvalidMetadataError creates a ValidationConfigurationError object", () => {
        const err: ValidationConfigurationError =
            ValidationConfigurationError.createInvalidMetadataError();
    ...
    it("createNegativeClockSkewError creates a ValidationConfigurationError object", () => {
        const err: ValidationConfigurationError =
            ValidationConfigurationError.createNegativeClockSkewError();
