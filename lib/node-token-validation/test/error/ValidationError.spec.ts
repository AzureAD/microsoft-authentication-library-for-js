...
describe("ValidationError", () => {
    ...
    it("createInvalidNonceError creates a ValidationError object", () => {
        ...
        expect(
            err.errorMessage.includes(ValidationErrorMessage.invalidNonce.desc)
        ).toBe(true);
        expect(
            err.message.includes(ValidationErrorMessage.invalidNonce.desc)
        ).toBe(true);
        expect(err.name).toBe("ValidationError");
        expect(err.stack?.includes("ValidationError.spec.ts")).toBe(true);
    });
    ...
    it("createInvalidCHashError creates a ValidationError object", () => {
        ...
        expect(
            err.errorMessage.includes(ValidationErrorMessage.invalidCHash.desc)
        ).toBe(true);
        expect(
            err.message.includes(ValidationErrorMessage.invalidCHash.desc)
        ).toBe(true);
        expect(err.name).toBe("ValidationError");
        expect(err.stack?.includes("ValidationError.spec.ts")).toBe(true);
    });
    ...
    it("createInvalidAtHashError creates a ValidationError object", () => {
        ...
        expect(
            err.errorMessage.includes(ValidationErrorMessage.invalidAtHash.desc)
        ).toBe(true);
        expect(
            err.message.includes(ValidationErrorMessage.invalidAtHash.desc)
        ).toBe(true);
        expect(err.name).toBe("ValidationError");
        expect(err.stack?.includes("ValidationError.spec.ts")).toBe(true);
    });
