[13:39:09] I/launcher - Running 1 instances of WebDriver
[13:39:09] I/local - Starting selenium standalone server...
[13:39:10] I/local - Selenium standalone server started at http://10.91.2.88:57407/wd/hub
[13:39:14] W/runner - Ignoring unknown extra flags: parameters. This will be an error in future versions, please use --disableChecks flag to disable the  Protractor CLI flag checks. 
Started
...
[13:39:24] W/element - more than one element found for locator By(xpath, .//*[.="Signed in"]) - the first result will be used
...
4 : Sign in Success
5 : logout method called
[13:39:34] W/element - more than one element found for locator By(xpath, .//*[.="Signed in"]) - the first result will be used
6 : Logout button clicked
7 : Redirecting back to Home page after Logout
8 : Verifying if Msal cache entries are reset
9 : Log out Success
...
[13:39:54] W/element - more than one element found for locator By(xpath, .//*[.="Signed in"]) - the first result will be used
...
{ authority: 'https://login.microsoftonline.com/msidlab4.onmicrosoft.com/',
  ...
  userIdentifier: 'OWY0ODgwZDgtODBiYS00YzQwLTk3YmMtZjdhMjNjNzAzMDg0.ZjY0NWFkOTItZTM4ZC00ZDFhLWI1MTAtZDFiMDlhNzRhOGNh' }
8 : logout method called
[13:40:07] W/element - more than one element found for locator By(xpath, .//*[.="Signed in"]) - the first result will be used
9 : Logout button clicked
10 : Redirecting back to Home page after Logout
11 : Verifying if Msal cache entries are resetted
12 : Log out Success
...
[13:40:20] W/element - more than one element found for locator By(xpath, .//*[.="Signed in"]) - the first result will be used
...
6 : logout method called
[13:40:34] W/element - more than one element found for locator By(xpath, .//*[.="Signed in"]) - the first result will be used
7 : Logout button clicked
8 : Redirecting back to Home page after Logout
9 : Verifying if Msal cache entries are reset
10 : Log out Success
...
[13:40:44] W/element - more than one element found for locator By(xpath, .//*[.="Signed in"]) - the first result will be used
...
{ authority: 'https://login.microsoftonline.com/msidlab4.onmicrosoft.com/',
  ...
  userIdentifier: 'OWY0ODgwZDgtODBiYS00YzQwLTk3YmMtZjdhMjNjNzAzMDg0.ZjY0NWFkOTItZTM4ZC00ZDFhLWI1MTAtZDFiMDlhNzRhOGNh' }
9 : logout method called
[13:40:53] W/element - more than one element found for locator By(xpath, .//*[.="Signed in"]) - the first result will be used
10 : Logout button clicked
11 : Redirecting back to Home page after Logout
12 : Verifying if Msal cache entries are resetted
13 : Log out Success
...
{ authority: 'https://login.microsoftonline.com/msidlab4.onmicrosoft.com/',
  ...
  userIdentifier: 'MDAwMDAwMDAtMDAwMC0wMDAwLWIzOTQtZjE3N2NhNGFjNjNl.OTE4ODA0MGQtNmM2Ny00YzViLWIxMTItMzZhMzA0YjY2ZGFk' }
7 : logout method called
[13:41:08] W/element - more than one element found for locator By(xpath, .//*[.="Signed in"]) - the first result will be used
8 : End of Test
...
{ authority: 'https://login.microsoftonline.com/msidlab4.onmicrosoft.com/',
  ...
  userIdentifier: 'MDAwMDAwMDAtMDAwMC0wMDAwLWIzOTQtZjE3N2NhNGFjNjNl.OTE4ODA0MGQtNmM2Ny00YzViLWIxMTItMzZhMzA0YjY2ZGFk' }
7 : logout method called
[13:41:19] W/element - more than one element found for locator By(xpath, .//*[.="Signed in"]) - the first result will be used
8 : End of Test
...
[13:41:33] W/element - more than one element found for locator By(xpath, .//*[.="Signed in"]) - the first result will be used
...
12 specs, 0 failures
Finished in 140.053 seconds

[13:41:34] I/local - Shutting down selenium standalone server.
[13:41:34] I/launcher - 0 instance(s) of WebDriver still running
[13:41:34] I/launcher - chrome #01 passed
