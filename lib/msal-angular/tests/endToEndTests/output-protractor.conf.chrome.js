[10:47:15] I/launcher - Running 1 instances of WebDriver
[10:47:15] I/hosted - Using the selenium server at https://hub-cloud.browserstack.com/wd/hub
[10:47:20] W/runner - Ignoring unknown extra flags: parameters. This will be an error in future versions, please use --disableChecks flag to disable the  Protractor CLI flag checks. 
Started
...
[10:47:34] W/element - more than one element found for locator By(xpath, .//*[.="Signed in"]) - the first result will be used
...
4 : Sign in Success
5 : logout method called
[10:47:53] W/element - more than one element found for locator By(xpath, .//*[.="Signed in"]) - the first result will be used
6 : Logout button clicked
7 : Redirecting back to Home page after Logout
8 : Verifying if Msal cache entries are reset
9 : Log out Success
...
[10:48:16] W/element - more than one element found for locator By(xpath, .//*[.="Signed in"]) - the first result will be used
...
[10:48:41] W/element - more than one element found for locator By(xpath, .//*[.="Signed in"]) - the first result will be used
...
{ authority: 'https://login.microsoftonline.com/msidlab4.onmicrosoft.com/',
  ...
  userIdentifier: 'OWY0ODgwZDgtODBiYS00YzQwLTk3YmMtZjdhMjNjNzAzMDg0.ZjY0NWFkOTItZTM4ZC00ZDFhLWI1MTAtZDFiMDlhNzRhOGNh' }
8 : logout method called
[10:49:05] W/element - more than one element found for locator By(xpath, .//*[.="Signed in"]) - the first result will be used
9 : Logout button clicked
10 : Redirecting back to Home page after Logout
11 : Verifying if Msal cache entries are resetted
12 : Log out Success
...
[10:49:32] W/element - more than one element found for locator By(xpath, .//*[.="Signed in"]) - the first result will be used
...
6 : logout method called
[10:49:56] W/element - more than one element found for locator By(xpath, .//*[.="Signed in"]) - the first result will be used
7 : Logout button clicked
8 : Redirecting back to Home page after Logout
9 : Verifying if Msal cache entries are reset
10 : Log out Success
...
[10:50:18] W/element - more than one element found for locator By(xpath, .//*[.="Signed in"]) - the first result will be used
...
{ authority: 'https://login.microsoftonline.com/msidlab4.onmicrosoft.com/',
  ...
  userIdentifier: 'OWY0ODgwZDgtODBiYS00YzQwLTk3YmMtZjdhMjNjNzAzMDg0.ZjY0NWFkOTItZTM4ZC00ZDFhLWI1MTAtZDFiMDlhNzRhOGNh' }
9 : logout method called
[10:50:42] W/element - more than one element found for locator By(xpath, .//*[.="Signed in"]) - the first result will be used
10 : Logout button clicked
11 : Redirecting back to Home page after Logout
12 : Verifying if Msal cache entries are resetted
13 : Log out Success
...
{ authority: 'https://login.microsoftonline.com/msidlab4.onmicrosoft.com/',
  ...
  userIdentifier: 'MDAwMDAwMDAtMDAwMC0wMDAwLWIzOTQtZjE3N2NhNGFjNjNl.OTE4ODA0MGQtNmM2Ny00YzViLWIxMTItMzZhMzA0YjY2ZGFk' }
7 : logout method called
[10:51:11] W/element - more than one element found for locator By(xpath, .//*[.="Signed in"]) - the first result will be used
8 : End of Test
...
{ authority: 'https://login.microsoftonline.com/msidlab4.onmicrosoft.com/',
  ...
  userIdentifier: 'MDAwMDAwMDAtMDAwMC0wMDAwLWIzOTQtZjE3N2NhNGFjNjNl.OTE4ODA0MGQtNmM2Ny00YzViLWIxMTItMzZhMzA0YjY2ZGFk' }
7 : logout method called
[10:51:33] W/element - more than one element found for locator By(xpath, .//*[.="Signed in"]) - the first result will be used
8 : End of Test
...
[10:51:56] W/element - more than one element found for locator By(xpath, .//*[.="Signed in"]) - the first result will be used
...
12 specs, 0 failures
Finished in 279.764 seconds

[10:52:11] I/launcher - 0 instance(s) of WebDriver still running
[10:52:11] I/launcher - chrome #01 passed
