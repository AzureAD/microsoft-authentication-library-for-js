    ...
    describe("login and acquireToken methods", () => {
        ...
        describe("ssoSilent", () => {
            it("success", done => {
                ...
                broadcastService.subscribe("msal:ssoSuccess", (payload: any) => {
                ...
                expect(UserAgentApplication.prototype.ssoSilent).toHaveBeenCalledWith(request);
            });
            ...
            it("failure", function(done) {
                ...
                broadcastService.subscribe("msal:ssoFailure", (error: AuthError) => {
                    expect(error.message).toBe(sampleError.message);
                    done();
                });
