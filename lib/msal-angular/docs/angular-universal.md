...
**Note:** MSAL Angular does not officially support Angular 17-19's server-side and prerendering capabilities. Using SSR with MSAL Angular may break your app.
